...
namespace practica2
{
    public partial class RelojAnalógico : Form
    {
      ...
      //estas ocsas se añaden yendo al formulario (diseño) y en eventos creas un "enlace" al pinchar
        private void RelojAnalógico_FormClosing_1(object sender, FormClosingEventArgs e)
        {
