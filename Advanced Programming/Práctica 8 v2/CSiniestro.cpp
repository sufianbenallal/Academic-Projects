...
// el primer objeto creado se crea con m_SigCodigo = 1

CSiniestro::CSiniestro(const std::string& desc) : m_Codigo(0), m_Descripcion(desc), m_HorasMO(0.0), m_CostePiezas(0.0), m_Coste(0.0)
